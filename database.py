...
class Database:
    def __init__(self):
        ...
        self.cursor.execute('CREATE TABLE IF NOT EXISTS rooms (id integer PRIMARY KEY, joinlink text, settings text, description text, players text, cr_date text, pl_num integer)') #settings - Ð½Ð°Ñ�Ñ‚Ñ€Ð¾Ð¹ÐºÐ¸ ÐºÐ¾Ð¼Ð½Ð°Ñ‚Ñ‹, ÐºÐ°Ðº Ð¸Ð¼ÐµÐ½Ð½Ð¾ Ñ…Ñ€Ð°Ð½Ñ�Ñ‚Ñ�Ñ� - Ð¿Ð¾ÐºÐ° Ð½ÐµÐ¿Ð¾Ð½Ñ�Ñ‚Ð½Ð¾, Ñ‚Ð¸Ð¿ text, Ð¸Ð±Ð¾ Ñ�Ð°Ð¼Ñ‹Ð¹ ÑƒÐ½Ð¸Ð²ÐµÑ€Ñ�Ð°Ð»ÑŒÐ½Ñ‹Ð¹
        self.conn.commit()
