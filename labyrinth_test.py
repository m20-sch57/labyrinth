...
if __name__ == '__main__':
    ...
    while True:
        ...
        if debug:
            ...
            print('├──────────────────────────────────────────────────────────┤')
        print('│health             :  {:<36}│'.format(TestLR.get_object('health').hp[ap]))
        print('│bombs              :  {:<36}│'.format(TestLR.get_object('ammo').bombs[ap]))
        print('│bullets            :  {:<36}│'.format(TestLR.get_object('ammo').bullets[ap]))
        print('└──────────────────────────────────────────────────────────┘')
